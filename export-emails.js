...
var getSqlScriptData = function(){
    ...
    getCompanyEmail((company) => {
        ...
        let sqlScript = `SELECT '"' + ua.Email + '"' as Email, ua.UserGuid as PhoneNumber, '"' + c.CompanyName + ':' + convert(nvarchar(50), c.CompanyGUID) + '"' as CompanyId, '"' + c.CompanyName + '"' as CompanyName FROM UserAccount as ua
